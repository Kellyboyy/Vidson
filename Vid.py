...
vidson = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']
vidsonchoice = random.choice(vidson)
agents = [
...
logo = """
\033[1;96m
 __   __  ___   ______   _______  _______  __    _ 
|  | |  ||   | |      | |       ||       ||  |  | |
|  |_|  ||   | |  _    ||  _____||   _   ||   |_| |
|       ||   | | | |   || |_____ |  | |  ||       |
|       ||   | | |_|   ||_____  ||  |_|  ||  _    |
 |     | |   | |       | _____| ||       || | |   |
  |___|  |___| |______| |_______||_______||_|  |__|'  
                                   \033[1;91m version: 1.1
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;96m: Vidson
\033[1;92mFb \033[1;96m: Vidson
\033[1;92mWhatsApp \033[1;96m: +2349052408601
\033[0m----------------------------------
""" 
...
def crack_select():
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Vidson
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
